...
<head>
    ...
    <title>Team Manager - Streamline Your Team Collaboration</title> <!-- Fonts -->
...
<body
    ...
    <div
        ...
        <main class="flex flex-col-reverse lg:flex-row">
            <div
                class="text-[14px] leading-[22px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-lg">

                <!-- Hero Section -->
                <div class="mb-8">
                    <h1 class="text-xl font-semibold mb-4 text-[#1b1b18] dark:text-[#EDEDEC]">Team Manager</h1>
                    <p class="text-lg text-[#706f6c] dark:text-[#A1A09A] ">
                        Streamline your team collaboration and project management with our comprehensive platform.
                    </p>
                    <p class="text-[#706f6c] dark:text-[#A1A09A]">
                        Organize teams, manage projects, assign tasks, and track progress efficiently in one centralized
                        workspace.
                    </p>
                </div>
                ...
                <!-- Key Features -->
                <div class="mb-8 mt-3">
                    <h2 class="text-xl font-semibold mb-5 text-[#1b1b18] dark:text-[#EDEDEC]">Key Features</h2>
                    <div class="space-y-4">
                        <div class="flex items-start gap-4 mt-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-[#1b1b18] dark:text-[#EDEDEC] mb-1">Team Management</h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Create and manage teams with
                                    role-based access control and member assignments</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 mt-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-[#1b1b18] dark:text-[#EDEDEC] mb-1">Project Organization
                                </h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Assign project managers and track
                                    project milestones with detailed oversight</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 mt-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-[#1b1b18] dark:text-[#EDEDEC] mb-1">Task Tracking</h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Create, assign, and monitor task
                                    progress in real-time with status updates</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 mt-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-[#1b1b18] dark:text-[#EDEDEC] mb-1">Super Admin Dashboard
                                </h3>
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Comprehensive oversight and
                                    management tools for complete system control</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @guest
                    <div class="space-y-4 mt-3">
                        <div class="flex flex-col sm:flex-row gap-3">
                            <a href="{{ route('login') }}"
                                class="inline-flex items-center justify-center px-6 py-3 bg-[#1b1b18] dark:bg-[#eeeeec] border border-[#1b1b18] dark:border-[#eeeeec] rounded-md font-medium text-white dark:text-[#1C1C1A] hover:bg-black dark:hover:bg-white transition-colors duration-200 text-center">
                                Sign In to Your Account
                            </a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="inline-flex items-center justify-center px-6 py-3 bg-transparent border border-[#1b1b18] dark:border-[#3E3E3A] rounded-md font-medium text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#1b1b18] hover:text-white dark:hover:bg-[#3E3E3A] transition-colors duration-200 text-center">
                                    Create New Account
                                </a>
                            @endif
                        </div>
                        ...
                        <div
                            class="text-sm text-[#706f6c] dark:text-[#A1A09A] p-4 bg-gray-50 dark:bg-gray-800/50 rounded-md">
                            <p>✨ <strong>New to Team Manager?</strong> Sign up to start organizing your teams and projects
                                today!</p>
                        </div>
                    </div>
                @else
                    <div
                        ...
                        <p class="text-green-800 dark:text-green-200 font-medium mb-2">Welcome back! You're already signed
                            in.</p>
                        <a href="{{ route('dashboard') }}"
                            class="inline-flex items-center text-green-700 dark:text-green-300 hover:text-green-900 dark:hover:text-green-100 transition-colors">
                            Go to Dashboard →
                        </a>
                    </div>
                @endguest
